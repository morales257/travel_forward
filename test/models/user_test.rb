...
class UserTest < ActiveSupport::TestCase
  ...
  test "name should be present" do
    @user.name = " "
    #assert that the user is not valid (pass if its not valid, fail if valid)
  ...
  test "reasonable name length" do
    @user.name = "a" * 51
    assert_not @user.valid?
  end

  test "reasonable email lenth" do
  ...
  test "email validation should accept valid addresses" do
    ...
    first.last@foo.jp alice+bob@bac.cn]
